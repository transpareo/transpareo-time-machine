...
```html
<script type="module"
        src="https://unpkg.com/transpareo-time-machine@2.16.0/dist-embed/embed.js"></script>
...
Pin a specific version (`@2.16.0`) for production. Use
...
```html
<link rel="stylesheet"
      href="https://unpkg.com/transpareo-time-machine@2.16.0/dist/transpareo-time-machine.css">
<script type="module"
        src="https://unpkg.com/transpareo-time-machine@2.16.0"></script>
```
